;ksaT22nossel.poo.moc.trofn egakcap
...
;)"avaj.3ksaT" ,"ksaT22nossel" ,"poo" ,"moc" ,"trofn" ,"crs"(fo.htaP = htap htaP        
;)htap(gnirtSdaer.seliF = seulaVgnirts gnirtS        
;)"etavirp" ,"cilbup"(ecalper.seulaVgnirts = tluser gnirtS        
